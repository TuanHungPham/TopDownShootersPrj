...
namespace MarchingBytes
{
    ...
    class Pool
    {
        ...
        public Pool(string poolName, GameObject poolObjectPrefab, Transform parent, int initialCount, bool fixedSize)
        {
    ...
    public class EasyObjectPool : MonoBehaviour
    {
        ...
        private void CreatePools()
        {
            foreach (PoolInfo currentPoolInfo in poolInfo)
            {
                ...
                Pool pool = new Pool(currentPoolInfo.poolName, currentPoolInfo.prefab, currentPoolInfo.parent,
